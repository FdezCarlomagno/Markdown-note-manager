...
const NoteTip = ({ children } : Props) => {
    ...
    return (
        <div className="flex flex-col m-3 text-gray-500 p-3 border border-l-8 border-t-0 border-r-0 border-b-0 border-blue-400 bg-gray-800 rounded-md shadow-md">
        <h2 className="text-lg text-blue-400 flex items-center gap-1">
